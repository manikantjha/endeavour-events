...
export default function FounderCard() {
  return (
    <div className="grid xs:grid-cols-1 md:grid-cols-[auto_1fr] gap-6 md:gap-8 border rounded-lg bg-white p-8 lg:w-[50%] xs:w-full justify-items-center items-center">
